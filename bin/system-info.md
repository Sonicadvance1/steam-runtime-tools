...
:   An object with architecture-specific information. The keys are
    ...
    **glx_drivers**
    :   An array of objects describing the GLX ICDs modules that have been
        ...
        Each object currently has only the following key:

        **library_path**
        :   Path to the ICD module that has been found.
